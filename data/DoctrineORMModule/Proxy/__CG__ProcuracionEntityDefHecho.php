 ...
 */
class DefHecho extends \Procuracion\Entity\DefHecho implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Procuracion\\Entity\\DefHecho' . "\0" . 'id', '' . "\0" . 'Procuracion\\Entity\\DefHecho' . "\0" . 'hecho', '' . "\0" . 'Procuracion\\Entity\\DefHecho' . "\0" . 'descripcion', '' . "\0" . 'Procuracion\\Entity\\DefHecho' . "\0" . 'activo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DefHecho $proxy) {
