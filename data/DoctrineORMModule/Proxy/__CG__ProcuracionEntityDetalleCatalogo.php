 ...
 */
class DetalleCatalogo extends \Procuracion\Entity\DetalleCatalogo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Procuracion\\Entity\\DetalleCatalogo' . "\0" . 'id', '' . "\0" . 'Procuracion\\Entity\\DetalleCatalogo' . "\0" . 'codigo', '' . "\0" . 'Procuracion\\Entity\\DetalleCatalogo' . "\0" . 'valor', '' . "\0" . 'Procuracion\\Entity\\DetalleCatalogo' . "\0" . 'activo', '' . "\0" . 'Procuracion\\Entity\\DetalleCatalogo' . "\0" . 'idCatalogo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (DetalleCatalogo $proxy) {
    ...
    public function setIdCatalogo(\Procuracion\Entity\CatalogoDatos $idCatalogo = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdCatalogo', [$idCatalogo]);

        return parent::setIdCatalogo($idCatalogo);
    }
    ...
    public function getIdCatalogo()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdCatalogo', []);

        return parent::getIdCatalogo();
    }
