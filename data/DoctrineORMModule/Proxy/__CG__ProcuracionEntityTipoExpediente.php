 ...
 */
class TipoExpediente extends \Procuracion\Entity\TipoExpediente implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Procuracion\\Entity\\TipoExpediente' . "\0" . 'id', '' . "\0" . 'Procuracion\\Entity\\TipoExpediente' . "\0" . 'tipo', '' . "\0" . 'Procuracion\\Entity\\TipoExpediente' . "\0" . 'activo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoExpediente $proxy) {
