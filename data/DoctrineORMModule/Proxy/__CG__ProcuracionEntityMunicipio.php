 ...
 */
class Municipio extends \Procuracion\Entity\Municipio implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Procuracion\\Entity\\Municipio' . "\0" . 'id', '' . "\0" . 'Procuracion\\Entity\\Municipio' . "\0" . 'idDepartamento', '' . "\0" . 'Procuracion\\Entity\\Municipio' . "\0" . 'codigo', '' . "\0" . 'Procuracion\\Entity\\Municipio' . "\0" . 'nombre'];
        }
