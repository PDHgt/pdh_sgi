 ...
 */
class Etapa extends \Procuracion\Entity\Etapa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Procuracion\\Entity\\Etapa' . "\0" . 'id', '' . "\0" . 'Procuracion\\Entity\\Etapa' . "\0" . 'etapa', '' . "\0" . 'Procuracion\\Entity\\Etapa' . "\0" . 'activo'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Etapa $proxy) {
