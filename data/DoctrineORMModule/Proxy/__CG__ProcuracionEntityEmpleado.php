 ...
 */
class Empleado extends \Procuracion\Entity\Empleado implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Procuracion\\Entity\\Empleado' . "\0" . 'id', '' . "\0" . 'Procuracion\\Entity\\Empleado' . "\0" . 'nombres', '' . "\0" . 'Procuracion\\Entity\\Empleado' . "\0" . 'apellidos', '' . "\0" . 'Procuracion\\Entity\\Empleado' . "\0" . 'puesto', '' . "\0" . 'Procuracion\\Entity\\Empleado' . "\0" . 'unidadadministrativa'];
        }
    ...
    public function setUnidadadministrativa(\Procuracion\Entity\Unidadadministrativa $unidadadministrativa = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setUnidadadministrativa', [$unidadadministrativa]);

        return parent::setUnidadadministrativa($unidadadministrativa);
    }
    ...
    public function getUnidadadministrativa()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getUnidadadministrativa', []);
