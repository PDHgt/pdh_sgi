 ...
 */
class Accion extends \Procuracion\Entity\Accion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Procuracion\\Entity\\Accion' . "\0" . 'id', '' . "\0" . 'Procuracion\\Entity\\Accion' . "\0" . 'accion'];
        }
