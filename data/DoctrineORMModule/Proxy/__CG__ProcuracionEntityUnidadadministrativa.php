 ...
 */
class Unidadadministrativa extends \Procuracion\Entity\Unidadadministrativa implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Unidadadministrativa $proxy) {
