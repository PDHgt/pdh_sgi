 ...
 */
class Departamento extends \Procuracion\Entity\Departamento implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Procuracion\\Entity\\Departamento' . "\0" . 'id', '' . "\0" . 'Procuracion\\Entity\\Departamento' . "\0" . 'codigo', '' . "\0" . 'Procuracion\\Entity\\Departamento' . "\0" . 'nombre'];
        }
