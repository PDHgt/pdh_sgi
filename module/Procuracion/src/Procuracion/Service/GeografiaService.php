...
class GeografiaService {
    ...
    public function ListarMunis(EntityManager $em) {
        $listado = $em->getRepository('Procuracion\Entity\Municipio')->findAll();
        return $listado;
    }

    public function ListarMunisPorDepto(EntityManager $em, $dep) {
